...
<body>
  ...
  <%
    ...
    //String sqlStr=" select abdp_urlcode from abdp_bookingdatetime_pay,abd_bookingdatetime where abdp_statustype='超时取消' and abdp_id_abd=abd_id   and abd_bookingDate>'2019-02-28'" ;
    ...
    String sqlStr=" select abdp_urlcode from abdp_bookingdatetime_pay,abd_bookingdatetime where abdp_statustype='已付款' and abdp_id_abd=abd_id   and abd_bookingDate>'2018-02-28' and abdp_money<>0" ;
