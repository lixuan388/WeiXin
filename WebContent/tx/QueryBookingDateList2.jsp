...
<head>
	...
	<script type="text/javascript">
		...
		function QueryChangeDate()
		{
			...
			$.ajax({
		        url:"/WeiXin/GetBookingDateTimeList?MP="+$('#selectMPChangeDate').val()+"&date="+QueryDate+"&d="+new Date().Format('yyyymmddhhnnss'),
		        type:'get',
		        dataType:'Json',
		...
		function DoChangeDate(id)
		{
			...
			$.ajax({
		        url:"/WeiXin/BackStage/ChangeDate?code="+UrlCode+"&id="+id+"&d="+new Date().Format('yyyymmddhhnnss'),
		        type:'get',
		        dataType:'Json',
		        success:function(data){
		        	if (data.MsgID!=1)
		...
		function CheckIn(UrlCode)
		{
			...
			$.ajax({
		        url:"/WeiXin/BookingDateCheckIn?code="+UrlCode+"&d="+new Date().Format('yyyymmddhhnnss'),
		        type:'get',
		        dataType:'Json',
		        success:function(data){
		        	if (data.MsgID!=1)
...
<jsp:include page="/res/temple/TabbarMenuBegin.jsp"/>
	...
	<form action="/WeiXin/tx/QueryBookingDateList.jsp" id ="QueryForm">
