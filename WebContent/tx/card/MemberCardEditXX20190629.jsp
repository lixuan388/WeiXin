...
<body>
  ...
  <div class="container">
    ...
    <div class="" style="font-size: 12px; line-height: 1em;">
      <div class="input-group" style="padding: 0px; width: 50%; float: left;">
        <span style="display: table-cell; text-align: right;" id="basic-addon1">充值日期：</span> <span style="color: blue; width: 100px; display: table-cell; padding: 5px;"><%=CreateDate%> <a
    ...
    <div class="" style="font-size: 12px; line-height: 1em;">
      <div class="input-group" style="padding: 0px; width: 50%; float: left;">
        <span style="display: table-cell; text-align: right;" id="basic-addon1">等级：</span> <span style="color: blue; width: 100px; display: table-cell; padding: 5px;"><%=Level%></span>
      </div>
      <div class="input-group" style="padding: 0px; width: 50%; float: left; margin-top: 0px;">
        <%
    ...
    <div class="" style="font-size: 12px; line-height: 1em;">
      <div class="input-group" style="padding: 0px; width: 100%; float: left;">
        <span style="display: table-cell; width: 72px; text-align: right;" id="basic-addon1"> <a href="javascript:void(0);" role="button" onclick="EditRemark()"> 备注<span
            class="glyphicon glyphicon-pencil" aria-hidden="true" style="margin-left: 5px; color: red;"
          ></span>：
        </a>
        </span> <span style="color: blue; display: table-cell; padding: 5px;"><%=Remark%></span>
      </div>
      <div style="clear: both; height: 1px; background-color: #E4E4E4;"></div>
    </div>
  </div>
  ...
  <div style="height: 100%; padding-bottom: 15px;">
    ...
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li role="EditInfo" class="tab-pane"><a href="#EditInfo" aria-controls="EditInfo" role="tab" data-toggle="tab" style="font-size: 12px;padding: 10px 10px;">客人资料</a></li>
    ...
    <div class="tab-content" style="height: 100%; padding-bottom: 0px;">
      ...
      <div role="tabpanel" class="tab-pane fade" id="Coupons" >
        <div class="container-fluid" id="" style="background-color: rgb(192, 192, 192); height: 100%; padding-top: 10px;overflow: auto;">
            <%
            int CouponsCount=0;
      ...
      <div role="tabpanel" class="tab-pane fade" id="Recharge" >
        <div class="container-fluid" id="" style="background-color: rgb(255, 67, 67); height: 100%; padding-top: 10px;overflow:auto">
          <div class="container-fluid" style="font-size: 0px; margin-top: 20px;">
            <%
            ...
            <div style="display: inline-block; width: 50%; padding: 2px; font-size: 14px;" name="RechargeCount">
              ...
              > <label for="RechargeCountRadio<%=i%>" style="height:54px;"class="btn btn-success">充值<%=RechargeAmount.getInt("amcra_Count")%>次<%=RechargeAmount.getInt("amcra_Money")%>元
              <%
          ...
          <div class="input-group" style="padding: 2px 30px;">
            <span class="input-group-addon" id="basic-addon1">充值次数</span> <input type="Number" class="form-control" id="RechargeCount" placeholder="充值次数" aria-describedby="basic-addon1" readonly value="0">
          </div>
          <div class="input-group" style="padding: 2px 30px;">
            <span class="input-group-addon" id="basic-addon1">充值金额</span> <input type="Number" class="form-control" id="RechargeMoney" placeholder="充值金额" ariadescribedby="basic-addon1" readonly value="0">
          </div>
          <div class="input-group" style="padding: 2px 30px;">
          ...
          <div class="input-group font1 text-center" style="line-height: 20px; padding: 2px 30px; margin-top: 5px">
          ...
          <div class="input-group" style="margin-top: 30px; padding: 2px 30px;">
          ...
          <div class="input-group font1 text-center" style="padding: 2px;margin-top: 10px;height: 1px;border-bottom: 1px solid #FFF;">
            ...
            <div class="container-fluid" style="font-size: 0px; margin-top: 20px;">
              ...
              %>
              <div style="display: inline-block; width: 50%; padding: 2px; font-size: 14px;" name="CouponsRadio">
      ...
      function SaveRecharge()
      {
          ...
          var Str="<div style='text-align: left;font-size: 21px;'>操作确认<br>充值："+count+"次<br>金额："+money+"元<br>延期："+EndDate;
          if (acid!=""){
...
function EditRemark()
{
  ...
  OpenWindows('<%=request.getContextPath()%>/tx/card/EditRemark.jsp?ID=<%=AmcID%>','修改备注',EditCreateTimeClose,null,"500px");
    ...
    window.location.href='<%=request.getContextPath()%>/tx/card/MemberCardEdit.jsp?ID=<%=AmcID%>&d=' + new Date().Format('yyyymmddhhnnss')
    }
