...
<jsp:include page="/res/temple/TabbarMenuBegin.jsp"/>
   	<div class="weui-cells__title"><p>预约情况</p></div>    
        <div class="weui-cells">
            <div class="weui-cell" style="padding-top: 1em;line-height: 2em;height:2em;">
            <%
                Date now=new Date();
                ...
                {   
                    ...
                    <div style="position: relative;" id="Day<%=i%>">
                      <a href="javascript:void(0);" onclick="LoadBookingData('<%=formatter2.format(now)%>');" class="weui-btn weui-btn_primary" 
                        style="line-height: 1em;padding:0px;width: 2em;margin-top: 0px;margin-right:1px;margin-left:5px;">
                        <span><%=formatter1.format(now)%></span>
                      </a>
                      <span class="weui-badge" style="position: absolute;top: -1.2em;right: -0.2em;z-index: 9;display:none">0</span>
                    </div>
                    <%
                    ...
                    <tr>
		                ...
		                <td colspan="2" >
				            <div style="position: relative;width: 100px;padding-top: 0.5em;margin-left: auto;margin-right: auto;" >
		                      <span>美容</span>
		                      <span class="weui-badge Count1" style="position: absolute;top: -0.5em;right: -0.2em;z-index: 9;display:none">0</span>
		                    </div>
                        </td>
		                <td colspan="2">		                                          
                            <div style="position: relative;padding-top: 0.5em;" >
                              <span>黄医生</span>
                              <span class="weui-badge Count2" style="position: absolute;top: -0.5em;right: -0.2em;z-index: 9;display:none">0</span>
                            </div>
                        </td>
		            </tr>
                </thead>
	  ...
	  $.ajax({
	    ...
	    success: function (data) {
	      ...
	      for (i = 0; i < data.DateList.length; i++)
	      {
	        ...
	        Guest = $('<a class="btn  btn-xs" href="javascript:void(0);" onclick="CreateCard(this)" role="button"><span>' + data.DateList[i].GuestName + '</span></a>')
...
<div class="modal" id="GuestInfoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  ...
  <div class="modal-dialog" role="document" style="width:100%;padding-right: 20px;margin-top: 100px;">
        ...
        <div class="weui-form-preview QueryDetil" style="" id="QueryDetil">
            ...
            <div class="weui-form-preview__hd striped" >       
                <div class="weui-form-preview__item">
                    ...
                    <em class="weui-form-preview__value"><span class="GuestName"></span></em>
                </div>
                
                <div class="weui-form-preview__item">
                    <label class="weui-form-preview__label">预约人手机</label>
                    <em class="weui-form-preview__value"><span class="GuestTel"></span></em>
                </div>                                               
                <div class="weui-form-preview__item">
                    <label class="weui-form-preview__label">挂号项目</label>
                    <em class="weui-form-preview__value"><span class="MedicalProject"></span></em>
                </div>
                <div class="weui-form-preview__item">
                    <label class="weui-form-preview__label">预约时间</label>
                    <em class="weui-form-preview__value"><span class="BookingTime"></span></em>
                </div>
                
                 <div class="weui-form-preview__item">
                     <label class="weui-form-preview__label">状态</label>
                     <em class="weui-form-preview__value"><span class="CheckIn" style="width: 100%;display: inline-block;"></span></em>
                 </div> 
                 <div id="CheckInDate"  class="weui-form-preview__item">
                     <label class="weui-form-preview__label">时间</label>
                     <em class="weui-form-preview__value"><span class="CheckInDate"></span></em>
                 </div> 
            ...
            <div id='CheckInBtn' class="weui-form-preview__ft" style="line-height: 30px;font-size: 14px;padding: 5px;">
                <a class="btn  " href="javascript:void(0);" onclick="ChangeType(this)" data-checkin=0 role="button">未到</a>
                <a class="btn  " href="javascript:void(0);" onclick="ChangeType(this)" data-checkin=1 role="button">已扣</a>
                <a class="btn  " href="javascript:void(0);" onclick="ChangeType(this)" data-checkin=2 role="button">已叫</a>
                <a class="btn  " href="javascript:void(0);" onclick="ChangeType(this)" data-checkin=3 role="button">爽约</a>
                <a class="btn  " href="javascript:void(0);" onclick="ChangeType(this)" data-checkin=4 role="button">未扣</a>
            </div>
            <div id='CheckInBtn2' class="weui-form-preview__ft" style="line-height: 30px;font-size: 14px;padding: 5px;">
                <a style="margin-left: auto;margin-right: auto;" id="GoToMemberCardEdit" class="btn btn-warning" href=""  role="button">跳转至次卡管理页面</a>
                <a style="margin-left: auto;margin-right: auto;width: 100px;" id="GoToChangeDate" class="btn btn-warning" href="javascript:void(0);" onclick="DoChangeDate()" role="button">改期</a>
            </div>       
...
<div class="modal" id="ManualEntryModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> 
  <div class="modal-dialog" role="document" style="max-width: 360px;margin-left: auto;margin-right: auto;margin-top: 100px;"> 
    <div class="modal-content">
      <div class="modal-body" style="min-height: 50px" > 
        <h ><center>手工排队</center></h>
        <div class="bs-example bs-example-form" >       
            <div class="input-group">
              <span class="input-group-addon" id="basic-addon1">姓名</span>
              <input type="text" class="form-control" id="ManualEntryGuestName"  placeholder="姓名" aria-describedby="basic-addon1" value="" >
            </div>
            <div class="input-group">
              <span class="input-group-addon" id="basic-addon1">电话</span>
              <input type="text" class="form-control" id="ManualEntryGuestTel"  placeholder="电话" aria-describedby="basic-addon1" value="" >
            </div>
