 ...
 */
@WebServlet("/booking/BookingDataListList2019.json")
public class BookingDataListList2019Servlet extends HttpServlet {
  private static final long serialVersionUID = 1L;
  
  /**
   * @see HttpServlet#HttpServlet()
   */
  public BookingDataListList2019Servlet() {
    super();
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    String DateTime = params.get("DateTime") == null ? "0" : (String) (params.get("DateTime")[0]);
    
    net.sf.json.JSONObject ReturnJson = new net.sf.json.JSONObject();
    try {
      net.sf.json.JSONArray DatasJson = new net.sf.json.JSONArray();
      
      Date bookingDate=new Date(Long.parseLong(DateTime));
      SimpleDateFormat bookingDateDateFormat=new SimpleDateFormat("yyyy-MM-dd");
      
      
      
      String Sql="select abd_id,abd_id_amp,abd_bookingdate,abd_bookingdatetime,abd_maxbooking,ifnull(abd_hasBooking,0) as abd_hasbooking,amp_money,amp_money2\r\n"
          ...
          + " and abd_maxbooking>0\r\n" + " and amps_flag =1 and abd_id_amp="+ID+" and abd_bookingdate='"+bookingDateDateFormat.format(bookingDate)+"'\r\n" + "order by abd_id_amp,abd_bookingdatetime";
